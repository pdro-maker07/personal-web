    ...
    <>
      ...
      <div className="tentang mt-32 py-10">
        ...
        <div className="tools mt-32">
          ...
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300 ">Berikut ini beberapa tools yang biasa saya pakai untuk pembuatan Wbsite ataupun Design</p>
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">

            {listTools.map((tool) => (
              <div className="flex items-center gap-2 p-3 border border-x-zinc-600 rounded-md hover:bg-zinc-800 group" key={tool.id} data-aos="fade-up" data-aos-duration="1000" data-aos-delay={tool.dad}>
      ...
      <div className="proyek mt-32 py-10">
        ...
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">Berikut beberapa proyek yang telah saya buat.</p>
      ...
      <div className="kontak mt-32 sm:p-10 p-0">
        ...
        <form action="https://formsubmit.co/putra.timur804@gmail.com" method="POST" className="bg-zinc-800 p-10  sm:w-fit w-full mx-auto rounded-md" autoComplete="off">
          <div className="flex flex-col gap-6">
            ...
            <div className="text-center">
              <button type="submit" className="bg-violet-700 p-3 rounded-lg block w-full border-zinc-600 hover:bg-violet-600">Kirim Pesan</button>
            </div>
          </div>
        </form>
      </div>
