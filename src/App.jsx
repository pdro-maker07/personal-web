    ...
    <>
      ...
      <div className="tentang mt-32 py-10">
        ...
        <div className="tools mt-32">
          ...
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50">Berikut ini beberapa tools yang biasa saya pakai untuk pembuatan Wbsite ataupun Design</p>
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">

            {listTools.map((tool) => (
              <div className="flex items-center gap-2 p-3 border border-x-zinc-600 rounded-md hover:bg-zinc-800 group" key={tool.id}>
      ...
      <div className="proyek mt-32 py-10">
        ...
        <p className="text-base/loose text-center opacity-50">Berikut beberapa proyek yang telah saya buat.</p>
